...
class SSL extends \Dondominio\API\Wrappers\AbstractWrapper
{
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#csr-decode-ssl-csrdecode
     ...
     * 
     * @link https://dondominio.dev/api/docs/api/#csr-create-ssl-csrcreate
     * @link http://en.wikipedia.org/wiki/Certificate_signing_request
     *
     * @param array $args
     *
     ...
     * 
     * @link https://dondominio.dev/api/docs/api/#ssl-product-list-ssl-productlist
     *
     * @param array $args
     *
     * @return	\Dondominio\API\Response\Response
     ...
     * Get product info
     *
     * @link https://dondominio.dev/api/docs/api/#ssl-product-get-info-ssl-productgetinfo
     *
     ...
     * 
     * @link https://dondominio.dev/api/docs/api/#ssl-list-ssl-list
     *
     * @param array $args
     *
     * @return	\Dondominio\API\Response\Response
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#ssl-get-info-ssl-getinfo
     *
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#ssl-create-ssl-create
     *
     * @param int $productId Certificate ID
     * @param array $args
     *
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#ssl-get-validation-emails-ssl-getvalidationemails
     *
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#ssl-change-validation-method-ssl-changevalidationmethod
     *
     * @param array $args
     *
     * @return	\Dondominio\API\Response\Response
     ...
     * - alt_validation_[Number]    string      Validation method of the Alternative Name (Just for multi-domain certificates)
     *
     * @link https://dondominio.dev/api/docs/api/#ssl-renew-ssl-renew
     *
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#ssl-resend-validation-mail-ssl-resendvalidationmail
     *
     * @param int $productId Certificate ID
     * @param array $args
     *
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#ssl-reissue-ssl-reissue
     *
     * @param int $certificateID Certificate ID
     * @param array $args
     *
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#ssl-multidomain-add-san-ssl-multidomainaddsan
     *
     * @param int $certificateID Certificate ID
     * @param array $args
     *
