...
class Domain extends \Dondominio\API\Wrappers\AbstractWrapper
{
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#check-domain-check
     *
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#check-for-transfer-domain-checkfortransfer
     *
     * @param string $domain Domain name to check
     *
     * @return \Dondominio\API\Response\Response
     ...
     *								Use "parking" for redirection & parking service.
        ...
        *
        * @link https://dondominio.dev/api/docs/api/#create-domain-create
        *
     ...
     *								Use "parking" for redirection & parking service.
        ...
        * - billing		array		Associative array of billing contact information.
        *
        * @link https://dondominio.dev/api/docs/api/#transfer-domain-transfer
        *
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#transfer-restart-domain-transferrestart
     *
     ...
     *								Use "default" to assign DonDominio/MrDomain hosting values.
        ...
        *
        * @link https://dondominio.dev/api/docs/api/#update-domain-update
        *
        * @param string $domain Domain name to update
        * @param string $updateType Type of information to modify (contact, nameservers, transferBlock, block, whoisPrivacy)
        * @param array $args Associative array of parameters
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#update-nameservers-domain-updatenameservers
     *
     ...
     * - billing		array		Associative array of billing contact information.
     *
     * @link https://dondominio.dev/api/docs/api/#update-contacts-domain-updatecontacts
     *
     * @param string $domain Domain name or Domain ID to be modified
     * @param array $args Associative array of parameters
     *
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#gluerecord-create-domain-gluerecordcreate
     *
     * @param string $domain Domain name or Domain ID to be modified
     ...
     * - ipv6			IPv6		IPv6 address for the DNS server
     *
     * @link https://dondominio.dev/api/docs/api/#gluerecord-update-domain-gluerecordupdate
     *
     * @param string $domain Domain name or Domain ID to be modified
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#gluerecord-delete-domain-gluerecorddelete
     *
     * @param string $domain Domain name or Domain ID to be modified
     ...
     *								status, contact, nameservers, authcode, service, gluerecords.
        *
        * @link https://dondominio.dev/api/docs/api/#list-domain-list
        *
        * @param array $args Associative array of parameters
        *
        * @return \Dondominio\API\Response\Response
     ...
     *								status, contact, nameservers, authcode, service, gluerecords, dnssec.
        *
        * @link https://dondominio.dev/api/docs/api/#get-info-domain-getinfo
        *
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#get-authcode-domain-getauthcode
     *
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#get-nameservers-domain-getnameservers
     *
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#get-gluerecords-domain-getgluerecords
     *
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#dnssec-create-domain-dnsseccreate
     *
     ...
     * ! digest		string		Digest for the DNSSEC entry
     *
     * @link https://dondominio.dev/api/docs/api/#dnssec-delete-domain-dnssecdelete
     *
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#renew-domain-renew
     *
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#whois-domain-whois
     *
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#resend-verification-mail-domain-resendverificationmail
     *
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#resend-foa-mail-domain-resendfoamail
     *
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#reset-foa-domain-resetfoa
     *
     * @param string $domain Domain or Domain ID to send the verification mail for
     *
     * @return \Dondominio\API\Response\Response
     ...
     * - page			integer		Number of the page to get (defaults to 1)
     *
     * @link https://dondominio.dev/api/docs/api/#get-history-domain-gethistory
     *
     ...
     * - page			integer		Number of the page to get (defaults to 1)
     *
     * @link https://dondominio.dev/api/docs/api/#list-deleted-domain-listdeleted
     *
     * @param array $args Associative array of parameters
     *
     * @return \Dondominio\API\Response\Response
