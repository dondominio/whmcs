...
class Service extends \Dondominio\API\Wrappers\AbstractWrapper
{
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#list-service-list
     *
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#get-info-service-getinfo
     *
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#create-service-create
     *
     * @param	string		$serviceName		Name of the service
     * @param	array		$args				Associative array of parameters (see table)
     *
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#renew-service-renew
     *
     * @param	string		$serviceName		Name of the service
     * @param	array		$args				Associative array of parameters (see table)
     *
     ...
     * ! productKey		string		One of: redir, mini, mail, mailplus, mailpro, basic, professional, advanced, corporate
     *
     * @link https://dondominio.dev/api/docs/api/#upgrade-service-upgrade
     *
     * @param	string		$serviceName		Name of the service
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#update-service-update
     *
     * @param	string		$serviceName		Name of the service
     * @param	array		$args				Associative array of parameters (see table)
     *
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#parking-get-info-service-parkinggetinfo
     *
     * @param	string		$serviceName		Name of the service
     *
     * @return	\Dondominio\API\Response\Response
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#parking-update-service-parkingupdate
     *
     * @param	string		$serviceName		Name of the service
     * @param	array		$args				Associative array of parameters (see table)
     *
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#webconstructor-login-service-webconstructorlogin
     *
     * @param	string		$serviceName		Name of the service
     * @param	array		$args				Associative array of parameters (see table)
     *
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#ftp-list-service-ftplist
     *
     * @param	string		$serviceName		Name of the service
     * @param	array		$args				Associative array of parameters (see table)
     *
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#ftp-get-info-service-ftpgetinfo
     *
     * @param	string		$serviceName		Name of the service
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#ftp-create-service-ftpcreate
     *
     * @param	string		$serviceName		Name of the service
     * @param	array		$args				Associative array of parameters (see table)
     *
     ...
     * ! quota			integer		Quota, in bytes, for the account. Min: 1MB
     *
     * @link https://dondominio.dev/api/docs/api/#ftp-update-service-ftpupdate
     *
     * @param	string		$serviceName		Name of the service
     * @param	string		$entityID			Entity identifier
     * @param	array		$args				Associative array of parameters (see table)
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#ftp-delete-service-ftpdelete
     *
     * @param	string		$serviceName		Name of the service
     * @param	string		$entityID			Entity identifier
     *
     ...
     * - filter			string		Filter results by this text
     *
     * @link https://dondominio.dev/api/docs/api/#database-list-service-ddbblist
     *
     * @param	string		$serviceName		Name of the service
     * @param	array		$args				Associative array of parameters (see table)
     *
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#database-get-info-service-ddbbgetinfo
     *
     * @param	string		$serviceName		Name of the service
     * @param	string		$entityID			Entity identifier
     *
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#database-create-service-ddbbcreate
     *
     * @param	string		$serviceName		Name of the service
     * @param	array		$args				Associative array of parameters (see table)
     *
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#database-update-service-ddbbupdate
     *
     * @param	string		$serviceName		Name of the service
     * @param	string		$entityID			Entity identifier
     *
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#database-delete-service-ddbbdelete
     *
     * @param	string		$serviceName		Name of the service
     * @param	string		$entityID			Entity identifier
     *
     ...
     * - filter			string		Filter results by this text
     *
     * @link https://dondominio.dev/api/docs/api/#subdomain-list-service-subdomainlist
     *
     * @param	string		$serviceName		Name of the service
     * @param	array		$args				Associative array of parameters (see table)
     *
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#subdomain-get-info-service-subdomaingetinfo
     *
     * @param	string		$serviceName		Name of the service
     * @param	string		$entityID			Entity identifier
     *
     ...
     * 
     * @link https://dondominio.dev/api/docs/api/#subdomain-create-service-subdomaincreate
     *
     * @param	string		$serviceName		Name of the service
     * @param	array		$args				Associative array of parameters (see table)
     *
     ...
     * - sslPath			string		FTP path where the subdomain will load with https ( required if sslCert is send )
     *
     * @link https://dondominio.dev/api/docs/api/#subdomain-update-service-subdomainupdate
     *
     * @param	string		$serviceName		Name of the service
     * @param	string		$entityID			Entity identifier
     *
     ...
     * Deletes a Subdomain.
     *
     * @link https://dondominio.dev/api/docs/api/#subdomain-delete-service-subdomaindelete
     *
     * @param	string		$serviceName		Name of the service
     * @param	string		$entityID			Entity identifier
     *
     ...
     * - filter			string		Filter results by this text
     *
     * @link https://dondominio.dev/api/docs/api/#redirect-list-service-redirectlist
     *
     * @param	string		$serviceName		Name of the service
     * @param	array		$args				Associative array of parameters (see table)
     *
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#redirect-get-info-service-redirectgetinfo
     *
     * @param	string		$serviceName		Name of the service
     * @param	string		$entityID			Entity identifier
     *
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#redirect-create-service-redirectcreate
     *
     * @param	string		$serviceName		Name of the service
     * @param	array		$args				Associative array of parameters (see table)
     *
     ...
     * ! type			string		One of: 301, 302, frame
     *
     * @link https://dondominio.dev/api/docs/api/#redirect-update-service-redirectupdate
     *
     * @param	string		$serviceName		Name of the service
     * @param	string		$entityID			Entity identifier
     *
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#redirect-delete-service-redirectdelete
     *
     * @param	string		$serviceName		Name of the service
     * @param	string		$entityID			Entity identifier
     *
     ...
     * - filter			string		Filter results by this text
     *
     * @link https://dondominio.dev/api/docs/api/#mail-list-service-maillist
     *
     * @param	string		$serviceName		Name of the service
     * @param	array		$args				Associative array of parameters (see table)
     *
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#mail-get-info-service-mailgetinfo
     *
     * @param	string		$serviceName		Name of the service
     * @param	string		$entityID			Entity identifier
     *
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#mail-create-service-mailcreate
     *
     * @param	string		$serviceName		Name of the service
     * @param	array		$args				Associative array of parameters (see table)
     *
     ...
     * ! password		string		Password for the account
     *
     * @link https://dondominio.dev/api/docs/api/#mail-update-service-mailupdate
     *
     * @param	string		$serviceName		Name of the service
     * @param	string		$entityID			Entity identifier
     *
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#mail-delete-service-maildelete
     *
     * @param	string		$serviceName		Name of the service
     * @param	string		$entityID			Entity identifier
     *
     ...
     * - filter			string		Filter results by this text
     *
     * @link https://dondominio.dev/api/docs/api/#mail-alias-list-service-mailaliaslist
     *
     * @param	string		$serviceName		Name of the service
     * @param	array		$args				Associative array of parameters (see table)
     *
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#mail-alias-get-info-service-mailaliasgetinfo
     *
     * @param	string		$serviceName		Name of the service
     * @param	string		$entityID			Entity identifier
     *
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#mail-alias-create-service-mailaliascreate
     *
     * @param	string		$serviceName		Name of the service
     * @param	array		$args				Associative array of parameters (see table)
     *
     ...
     * ! target			string		Target Email account(s) (for more than one, use ',')
     *
     * @link https://dondominio.dev/api/docs/api/#mail-alias-update-service-mailaliasupdate
     *
     * @param	string		$serviceName		Name of the service
     * @param	string		$entityID			Entity identifier
     *
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#mail-alias-delete-service-mailaliasdelete
     *
     * @param	string		$serviceName		Name of the service
     * @param	string		$entityID			Entity identifier
     *
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#dns-zone-list-service-dnslist
     *
     * @param	string		$serviceName		Name of the service
     * @param	array		$args				Associative array of parameters (see table)
     *
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#dns-zone-get-info-service-dnsgetinfo
     *
     * @param	string		$serviceName		Name of the service
     * @param	string		$entityID			Entity identifier
     *
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#dns-zone-create-service-dnscreate
     *
     * @param	string		$serviceName		Name of the service
     * @param	array		$args				Associative array of parameters (see table)
     *
     ...
     * - priority		string		Priority of this zone (use '-' for default)
     *
     * @link https://dondominio.dev/api/docs/api/#dns-zone-update-service-dnsupdate
     *
     * @param	string		$serviceName		Name of the service
     * @param	string		$entityID			Entity identifier
     *
     ...
     * Deletes a DNS zone.
     *
     * @link https://dondominio.dev/api/docs/api/#dns-zone-delete-service-dnsdelete
     *
     * @param	string		$serviceName		Name of the service
     * @param	string		$entityID			Entity identifier
     *
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#dns-zone-restore-service-dnsrestore
     *
     * @param	string		$serviceName		Name of the service
     *
     * @return	\Dondominio\API\Response\Response
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#dns-zone-set-service-dnssetzone
     *
     * @param	string		$serviceName		Name of the service
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#dns-zone-delete-all-service-dnsdeleteall
     *
     * @param	string		$serviceName		Name of the service
     *
     * @return	\Dondominio\API\Response\Response
