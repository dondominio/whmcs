...
class Tool extends \Dondominio\API\Wrappers\AbstractWrapper
{
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#hello-tool-hello
     *
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#idn-converter-tool-idnconverter
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#domain-suggests-tool-domainsuggests
     *
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#get-table-tool-gettable
     *
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#csr-decode-tool-csrdecode
     ...
     * Accepts an associative array with the following parameters:
     *
     * @link https://dondominio.dev/api/docs/api/#dig-tool-dig
     ...
     * Accepts an associative array with the following parameters:
     *
     * @link https://dondominio.dev/api/docs/api/#zonecheck-tool-zonecheck
     *
     * ! = required
