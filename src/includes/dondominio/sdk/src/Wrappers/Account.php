...
class Account extends \Dondominio\API\Wrappers\AbstractWrapper
{
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#info-account-info
     *
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#zones-account-zones
     *
     * @return \Dondominio\API\Response\Response
     */
     ...
     *
     * @link https://dondominio.dev/api/docs/api/
     *
     * @return \Dondominio\API\Response\Response
     */
