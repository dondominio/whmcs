...
{	
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#list-contact-list
     *
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#get-info-contact-getinfo
     *
     ...
     *
     * @link https://dondominio.dev/api/docs/api/#resend-verification-mail-contact-resendverificationmail
     *
     * @return \Dondominio\API\Response\Response
     */
     ...
     * ! Country    	string		Country code (https://dondominio.dev/api/docs/country-codes/)
     * - OrgName    	string		Organization or company name
     * - OrgType    	string		Spanish organization type (https://dondominio.dev/api/docs/esjuridic/)
     * - Fax        	string		Fax number in +DD.DDDDDDDDD format
     * 
     * @link https://dondominio.dev/api/docs/api/#create-contact-create
     *
     * @return \Dondominio\API\Response\Response
     */
