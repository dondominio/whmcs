        ...
        <table class='form' width='100%' border='0' cellspacing='2' cellpadding='3'>
            <tbody>
                ...
                <tr>
                    ...
                    <td class='fieldarea'>
                        <label><input type='radio' name='watchlist' value="disable" {$watchlist_is_disable} /> {$LANG.settings_watch_ignore_disable}</label>
                        <label><input type='radio' name='watchlist' value="watch" {$watchlist_is_watch} /> {$LANG.settings_watch_ignore_watch}</label>
                        <label><input type='radio' name='watchlist'  value="ignore" {$watchlist_is_ignore} /> {$LANG.settings_watch_ignore_ignore}</label>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td width='200'>
                                        ...
                                        <select id='watchlisted_tlds' name='watchlisted_tlds[]' multiple size='20' style='width: 100%;'>
