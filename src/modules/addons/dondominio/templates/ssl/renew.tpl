        ...
        <div class="panel-body">
            <div class="widget-content-padded">
                ...
                <div class="btn-group mb-10">
                    <a href="#" data-contact-info="id" class="btn btn-default active">
                        {$LANG.ssl_contact_id}
                    </a>
                    <a href="#" data-contact-info="data" class="btn btn-default">
                ...
                <div data-contact-inputs="data" style="display: none;">
                    ...
                    <div class="form-group">
                        ...
                        <select data-contact-type type="text" class="form-control" name="contact_type" id="contact_type"
                            disabled="true">
                            {html_options options=$contact_types selected=$contact_type}
                        </select>
                    </div>
                    ...
                    <div data-org-inputs class="form-group" style="display: none;">
                        ...
                        <input type="text" class="form-control" name="contact_org_name" id="contact_org_name"
                            value="{$user.companyname}" disabled="true">
                    </div>

                    <div data-org-inputs class="form-group" style="display: none;">
                        <label for="contact_org_type">{$LANG.ssl_contact_org_type}</label>
                        <input type="text" class="form-control" name="contact_org_type" id="contact_org_type"
                            disabled="true">
                    </div>

                    <div class="form-group">
                        <label for="contact_iden_num">{$LANG.ssl_contact_iden_num}</label>
                        <input type="text" class="form-control" name="contact_iden_num" id="contact_iden_num"
                            value="{$vat_number}" disabled="true">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="contact_phone" id="contact_phone"
                            value="{$user.phonenumberformatted}" disabled="true">
                    </div>

                    <div class="form-group">
                        <label for="contact_fax_phone">{$LANG.ssl_contact_fax}</label>
                        <input type="text" class="form-control" name="contact_fax_phone" id="contact_fax_phone"
                            value="{$user.fax}" disabled="true">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="contact_post_code" id="contact_post_code"
                            value="{$user.postcode}" disabled="true">
                    </div>

                    <div class="form-group">
                        <label for="contact_city">{$LANG.ssl_contact_city}</label>
                        <input type="text" class="form-control" name="contact_city" id="contact_city"
                            value="{$user.city}" disabled="true">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="contact_state" id="contact_state"
                            value="{$user.state}" disabled="true">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="contact_country" id="contact_country"
                            value="{$user.countrycode}" disabled="true">
                    </div>
...
<input type="hidden" data-is-contact-data value="{$is_contact_data}" />
{literal}
<script>
    ...
    function initContactData() {
        let isContactData = $('[data-is-contact-data]').val();
        let contactType = $('[data-contact-type]').val();

        console.log(isContactData);

        if (isContactData) {
            $('[data-contact-info="data"]')[0].click();
        }
